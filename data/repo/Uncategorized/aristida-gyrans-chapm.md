---
title: "Corkscrew Threeawn"
description: "Care guide for Aristida gyrans Chapm."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/aristida-gyrans-chapm
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Corkscrew Threeawn](https://upload.wikimedia.org/wikipedia/commons/e/ec/Aristida_purpurea_form.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southeastern United States (primarily Florida, Georgia, Alabama, Mississippi, South Carolina) |
| **🌡️ Climate** | Temperate Grassland/Scrubland |
| **☀️ Light** | Full sun (at least 6-8 hours of direct sunlight daily) |
| **💧 Water** | Low; allow soil to dry completely between waterings. Drought-tolerant once established. |
...
## 🧤 Care Instructions
This resilient grass thrives in full sun and requires very well-drained, sandy soils, mirroring its native dry pineland and scrub habitats. Water sparingly, allowing the soil to dry out completely between irrigations, and avoid rich fertilization as it is adapted to nutrient-poor conditions.

### 🧪 Fertilizer
Very low; thrives in poor, sandy soils. Minimal or no fertilization is typically needed.
