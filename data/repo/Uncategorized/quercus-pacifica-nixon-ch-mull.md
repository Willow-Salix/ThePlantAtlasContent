---
title: "Channel Island Scrub Oak"
description: "Care guide for Quercus pacifica Nixon & C.H. Mull."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/quercus-pacifica-nixon-ch-mull
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Channel Island Scrub Oak](https://upload.wikimedia.org/wikipedia/commons/a/af/Quercus_robur.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Channel Islands of California and adjacent Southern California mainland, USA. |
| **🌡️ Climate** | Mediterranean Chaparral / Arid Scrubland |
| **☀️ Light** | Full sun (6+ hours of direct sunlight daily) is essential, mimicking its open, exposed native habitat. |
| **💧 Water** | Highly drought-tolerant once established; water deeply but infrequently during extended dry periods, especially in summer. Requires excellent drainage. |
...
## 🧤 Care Instructions
This resilient oak thrives in full sun and requires minimal water once established, adapting well to dry conditions. Ensure excellent drainage and avoid over-fertilization, mimicking its lean, native chaparral environment for optimal health.

### 🧪 Fertilizer
Generally low nutrient needs. Fertilize sparingly, if at all, with a slow-release, balanced fertilizer only if growth is stagnant, particularly during establishment.
