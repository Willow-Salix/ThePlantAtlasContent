---
title: "Rich's Sea Blite"
description: "Care guide for Suaeda richii Fernald"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/suaeda-richii-fernald
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Rich's Sea Blite](https://upload.wikimedia.org/wikipedia/commons/f/f1/Suaeda_maritima.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Atlantic coast of North America, specifically from New England south to Virginia (e.g., Massachusetts, New York, New Jersey, Maryland). |
| **🌡️ Climate** | Temperate Coastal Salt Marsh |
| **☀️ Light** | Full sun (6+ hours of direct sunlight daily) |
| **💧 Water** | Consistently moist to wet soil; tolerates brackish or saline water and periodic inundation by tides. |
...
## 🧤 Care Instructions
Rich's Sea Blite thrives in full sun and requires consistently moist to wet, saline or brackish soil, mimicking its native temperate coastal salt marsh environment. It is well-adapted to high salinity and fluctuating water levels, making minimal fertilization necessary once established. Ensuring adequate light and water management is key for its care.

### 🧪 Fertilizer
Low to moderate. This plant is adapted to the specific nutrient profiles of saline coastal soils; excessive fertilization is generally unnecessary and can be detrimental.
