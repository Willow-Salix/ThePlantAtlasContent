---
title: "Giant Brake"
description: "Care guide for Pteris tripartita Sw."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/pteris-tripartita-sw
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Giant Brake](https://upload.wikimedia.org/wikipedia/commons/b/b9/Pteris_vittata.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Tropical and subtropical regions, including parts of Southeast Asia (e.g., Malaysia, Philippines), India, Australia, and various Pacific Islands. |
| **🌡️ Climate** | Tropical Rainforest to Subtropical Moist Forest |
| **☀️ Light** | Indirect bright light to partial shade. Prefers dappled sunlight or deep shade; direct sun will scorch its fronds. |
| **💧 Water** | Keep the soil consistently moist but not waterlogged. Requires high humidity, which can be maintained through regular misting, a pebble tray, or by grouping with other plants. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=509758)

## 🧤 Care Instructions
The Giant Brake thrives in environments that mimic its native tropical forest floor, demanding consistent moisture and high humidity. It prefers indirect light to partial shade, and benefits from light, regular feeding during its growth period to maintain its lush foliage.

### 🧪 Fertilizer
Fertilize lightly with a diluted, balanced liquid fertilizer every 2-4 weeks during the active growing season (spring and summer). Reduce or cease feeding in winter.
