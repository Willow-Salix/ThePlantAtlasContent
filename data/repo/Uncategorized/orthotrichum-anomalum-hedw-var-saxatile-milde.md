---
title: "Rock Bristle Moss"
description: "Care guide for Orthotrichum anomalum Hedw. var. saxatile Milde"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/orthotrichum-anomalum-hedw-var-saxatile-milde
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Rock Bristle Moss
### *Orthotrichum anomalum Hedw. var. saxatile Milde*

![Rock Bristle Moss](https://upload.wikimedia.org/wikipedia/commons/f/fd/Orthotrichum_sp.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Europe, North America, and parts of Asia, particularly temperate and boreal regions |
| **🌡️ Climate** | Temperate and Boreal Rocky Outcrops |
| **☀️ Light** | Bright indirect light to partial direct sun, especially when humidity is consistently high. |
| **💧 Water** | Requires consistent moisture and high humidity; mist frequently and keep substrate damp but well-drained. Avoid waterlogging. |
...
## 🧤 Care Instructions
This rock-dwelling moss thrives with bright indirect to partial direct sun exposure, provided high humidity is maintained. Keep its substrate consistently damp but ensure excellent drainage, and avoid over-fertilization as it prefers nutrient-poor environments.

### 🧪 Fertilizer
Very minimal to no fertilization needed, as mosses thrive in nutrient-poor conditions.
