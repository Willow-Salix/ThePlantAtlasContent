---
title: "Pygmy Bristle-moss"
description: "Care guide for Orthotrichum pumilum Sw. var. fallax (Bruch) Bertsch"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/orthotrichum-pumilum-sw-var-fallax-bruch-bertsch
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Pygmy Bristle-moss
### *Orthotrichum pumilum Sw. var. fallax (Bruch) Bertsch*

![Pygmy Bristle-moss](https://upload.wikimedia.org/wikipedia/commons/f/fd/Orthotrichum_sp.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Widespread in temperate regions of the Northern Hemisphere, including Europe and North America. |
| **🌡️ Climate** | Temperate Forest |
| **☀️ Light** | Partial Shade to Dappled Light. As an epiphyte or saxicolous moss in a temperate forest, it grows on tree bark or rocks, protected from direct, intense sunlight. |
| **💧 Water** | Consistent moisture is crucial; regular misting or high ambient humidity is essential. Mosses absorb water directly and require frequent wetting but should not remain waterlogged. |
...
## 🧤 Care Instructions
This moss thrives in conditions mimicking its temperate forest habitat, requiring consistent high humidity and protection from direct sunlight. Ensure regular moisture by misting or providing a humid environment, avoiding prolonged waterlogging. Fertilization is generally unnecessary and can be detrimental to its health.

### 🧪 Fertilizer
No specific fertilizer required. Mosses derive sufficient nutrients from rainwater and airborne particles; excess fertilization can be harmful.
