---
title: "Sphagnum"
description: "Care guide for Sphagnum teres (Schimp.) Ångstr."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/sphagnum-teres-schimp-ngstr
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Circumboreal regions, including North America, Europe, and Asia. |
| **🌡️ Climate** | Cool Temperate and Boreal Wetlands (fens, bogs, wet forests). |
| **☀️ Light** | Prefers partial shade to bright indirect light; avoid direct, intense sun which can dry it out. |
| **💧 Water** | Requires constant moisture; keep consistently wet, often in standing water or extremely high humidity, never allowing it to dry out. |
...
## 🧤 Care Instructions
Sphagnum teres thrives in consistently wet, humid, and cool environments with partial shade, mimicking its native bog and fen habitats. It requires very little to no supplemental fertilization due to its adaptation to nutrient-poor conditions.

### 🧪 Fertilizer
Very low to no fertilizer; high nutrient levels can be harmful as it is adapted to nutrient-poor, acidic environments.
