---
title: "Forbes' Spurge"
description: "Care guide for Euphorbia forbesii Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-forbesii-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Forbes' Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Hawaiian Islands (Maui, Molokai, Lanai) |
| **🌡️ Climate** | Tropical Dry to Mesic Forest and Shrubland |
| **☀️ Light** | Bright indirect to full sun; it thrives with good light exposure, similar to its open native habitat on rocky slopes. |
| **💧 Water** | Allow soil to dry out completely between waterings; due to its dry forest origin, it is drought tolerant once established and requires excellent drainage to prevent root rot. |
...
## 🧤 Care Instructions
Forbes' Spurge is a Hawaiian native that thrives in bright light conditions and well-draining soil, accustomed to periods of dryness. Mimic its tropical dry forest habitat by providing ample sun and allowing the soil to dry out thoroughly between infrequent waterings, with very light fertilization during periods of active growth.

### 🧪 Fertilizer
Minimal fertilization; a balanced, diluted liquid fertilizer can be applied once or twice during the active growing season, but over-fertilizing should be avoided.
