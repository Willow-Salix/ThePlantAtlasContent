---
title: "Dense Mistletoe"
description: "Care guide for Phoradendron bolleanum (Seem.) Eichl. ssp. densum (Torr. ex Trel.) Wiens"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/phoradendron-bolleanum-seem-eichl-ssp-densum-torr-ex-trel-wiens
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Dense Mistletoe
### *Phoradendron bolleanum (Seem.) Eichl. ssp. densum (Torr. ex Trel.) Wiens*

![Dense Mistletoe](https://upload.wikimedia.org/wikipedia/commons/2/2f/Phoradendroncalifornicum2.jpg)
...
| **🌡️ Climate** | Arid and Semi-Arid Woodlands, Chaparral, and Desert Scrub |
| **☀️ Light** | Bright indirect to full sun; it grows epiphytically on host trees, often exposed to high light. |
| **💧 Water** | Very low; as a parasitic plant, it obtains all necessary water from its host tree and is extremely drought-tolerant. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=5692214)

## 🧤 Care Instructions
This mistletoe is a hemi-parasitic plant that cannot be cultivated conventionally, as it requires a specific host tree for survival. It thrives in bright, arid conditions typical of its native desert and woodland habitats. Care would primarily involve ensuring a healthy host tree rather than direct intervention for the mistletoe itself.

### 🧪 Fertilizer
None directly; this hemi-parasite draws all essential nutrients from its host plant.
