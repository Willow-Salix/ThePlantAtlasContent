---
title: "Arizona Spurge"
description: "Care guide for Euphorbia arizonica Engelm."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-arizonica-engelm
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Arizona Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (Arizona, California) and Northwestern Mexico (Baja California) |
| **🌡️ Climate** | Arid to semi-arid desert scrubland (Sonoran Desert) |
| **☀️ Light** | Full sun, requiring at least 6-8 hours of direct sunlight daily. Tolerates some partial shade in extremely hot climates. |
| **💧 Water** | Extremely drought-tolerant. Water deeply but infrequently, allowing soil to dry out completely between waterings. Reduce watering significantly during cooler, dormant periods. |
...
## 🧤 Care Instructions
This desert native thrives in full sun and requires very little water, making it ideal for xeriscaping. Provide well-draining soil and minimal fertilization to prevent root rot and ensure healthy growth in conditions mimicking its arid natural habitat.

### 🧪 Fertilizer
Low fertilizer needs. A diluted balanced liquid fertilizer can be applied once or twice during the growing season (spring/summer) if desired, but often not essential.
