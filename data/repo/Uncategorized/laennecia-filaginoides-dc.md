---
title: "Trans-Pecos Horseweed"
description: "Care guide for Laennecia filaginoides DC."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/laennecia-filaginoides-dc
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Trans-Pecos Horseweed
### *Laennecia filaginoides DC.*

![Trans-Pecos Horseweed](https://upload.wikimedia.org/wikipedia/commons/1/13/Laennecia_coulteri.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (Trans-Pecos Texas, New Mexico, Arizona) and northern Mexico |
| **🌡️ Climate** | Arid Scrubland / Chihuahuan Desert |
| **☀️ Light** | Requires full sun (6+ hours of direct sunlight daily) to mimic its native open, sunny desert habitat. |
| **💧 Water** | Drought-tolerant; water deeply but infrequently, allowing the soil to dry out completely between waterings. Avoid overwatering, which can lead to root rot. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=23663327)

## 🧤 Care Instructions
This desert native thrives in full sun and requires minimal watering, preferring to dry out between waterings. It is highly drought-tolerant and adapted to lean soils, meaning very little to no fertilization is needed.

### 🧪 Fertilizer
Low fertilizer needs. If necessary, a very dilute, balanced fertilizer can be applied once in spring, but it generally thrives in lean, poor soils.
