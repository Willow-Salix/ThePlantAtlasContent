---
title: "Lovegrass"
description: "Care guide for Chrysopogon elliottii C. Mohr"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/chrysopogon-elliottii-c-mohr
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Lovegrass
### *Chrysopogon elliottii C. Mohr*

![Lovegrass](https://upload.wikimedia.org/wikipedia/commons/2/20/Starr_020124-8001_Eragrostis_cilianensis.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Tropical and Subtropical Asia (e.g., India, Southeast Asia, China), extending to parts of Oceania and Australia. |
| **🌡️ Climate** | Tropical and Subtropical Grasslands/Savannas |
| **☀️ Light** | Full sun exposure is preferred, thriving in open, unshaded areas similar to its native grassland habitats. |
| **💧 Water** | Requires moderate to high watering during its active growth periods, especially in warm climates. It tolerates brief dry spells but prefers consistently moist (not waterlogged) soil, mirroring tropical rainfall patterns. |
...
## 🧤 Care Instructions
This resilient grass thrives in full sun and requires moderate to high watering, typical of its tropical and subtropical grassland origins. It has low to moderate fertilizer needs, making it relatively low-maintenance once established in appropriate conditions.

### 🧪 Fertilizer
Low to moderate fertilizer needs. A balanced, general-purpose fertilizer can be applied sparingly during the growing season to support robust growth, consistent with the fertility of natural grassland soils.
