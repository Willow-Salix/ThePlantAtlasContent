---
title: "Pohe Hiwa"
description: "Care guide for Viola kauaensis A. Gray"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/viola-kauaensis-a-gray
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Pohe Hiwa](https://upload.wikimedia.org/wikipedia/commons/c/cd/Bratsche.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Kauaʻi, Hawaiian Islands |
| **🌡️ Climate** | Wet Montane Forest / Montane Bog |
| **☀️ Light** | Partial shade to filtered light; avoid intense direct sun. |
| **💧 Water** | Maintain consistently moist soil, ensuring good drainage. Requires high humidity and frequent watering. |
...
## 🧤 Care Instructions
This plant thrives in high humidity and consistently moist, well-draining soil, mimicking its native Hawaiian wet montane forest and bog habitats. Provide partial shade to filtered light and apply light to moderate fertilizer during active growth to ensure optimal health.

### 🧪 Fertilizer
Light to moderate fertilization with a balanced, possibly acid-leaning, liquid fertilizer during the growing season. Avoid over-fertilizing.
