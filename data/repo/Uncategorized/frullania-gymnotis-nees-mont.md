---
title: "Frullania Gymnotis"
description: "Care guide for Frullania gymnotis Nees & Mont."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/frullania-gymnotis-nees-mont
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Frullania Gymnotis](https://upload.wikimedia.org/wikipedia/commons/a/a0/Frullania_tamarisci_200108b.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Macaronesia (e.g., Canary Islands, Madeira), tropical and subtropical South America, and parts of tropical Africa |
| **🌡️ Climate** | Tropical and Subtropical Moist Forests / Rainforests |
| **☀️ Light** | Low to very low light; thrives in full shade or dappled light, mimicking the understory of dense forests. |
| **💧 Water** | Requires constant high humidity and consistently moist, but not waterlogged, conditions; daily misting or a terrarium environment is ideal to prevent desiccation. |
...
## 🧤 Care Instructions
This liverwort thrives in consistently high humidity and deep shade, typical of its native tropical and subtropical moist forest habitats. It requires a constantly moist growing medium and excellent air circulation to prevent fungal issues, with minimal to no fertilization.

### 🧪 Fertilizer
Very low to no fertilizer needed; if used, apply an extremely diluted, balanced liquid fertilizer very sparingly (e.g., once every few months).
