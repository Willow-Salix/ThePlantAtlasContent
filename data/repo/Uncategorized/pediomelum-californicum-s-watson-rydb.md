---
title: "California Indian Breadroot"
description: "Care guide for Pediomelum californicum (S. Watson) Rydb."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/pediomelum-californicum-s-watson-rydb
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![California Indian Breadroot](https://upload.wikimedia.org/wikipedia/commons/2/2f/Pediomelum_subacaule_Kaldari_01.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (primarily California, Arizona, Nevada, Utah) and Baja California, Mexico. |
| **🌡️ Climate** | Arid Scrubland |
| **☀️ Light** | Requires full sun exposure, typical of its native open, unshaded habitats in arid regions. |
| **💧 Water** | Very low watering needs; thrives in dry conditions and is highly drought-tolerant. Allow soil to dry out completely between infrequent waterings. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=14297733)

## 🧤 Care Instructions
This plant thrives on neglect in conditions mimicking its arid scrubland home, requiring abundant sunlight and very infrequent watering. Avoid overwatering and excessive fertilization to ensure its health.

### 🧪 Fertilizer
Low fertilizer requirements. Native soils are often poor in nutrients, so rich fertilization is unnecessary and potentially harmful.
