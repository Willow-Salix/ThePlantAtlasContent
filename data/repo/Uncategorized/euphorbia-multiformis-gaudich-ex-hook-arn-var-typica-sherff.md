---
title: "'Akoko"
description: "Care guide for Euphorbia multiformis Gaudich. ex Hook. & Arn. var. typica Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-multiformis-gaudich-ex-hook-arn-var-typica-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# 'Akoko
### *Euphorbia multiformis Gaudich. ex Hook. & Arn. var. typica Sherff*

!['Akoko](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Hawaiian Islands (Kauaʻi, Oʻahu, Molokaʻi, Lānaʻi, Maui, Hawaiʻi) |
| **🌡️ Climate** | Dry to Mesic Shrubland and Forest |
| **☀️ Light** | Prefers full sun to partial shade. Can tolerate high light conditions common in open shrublands but also benefits from some protection in the hottest afternoon sun. |
| **💧 Water** | Tolerates periods of drought once established, but thrives with regular watering when the top 1-2 inches of soil are dry. Avoid waterlogging; requires excellent drainage. |
...
## 🧤 Care Instructions
This Hawaiian native thrives in bright conditions, preferring full sun to partial shade. It requires well-draining soil and should be watered when the top few inches become dry, tolerating some drought. Fertilize sparingly with a balanced, slow-release product during its active growth.

### 🧪 Fertilizer
Low to moderate fertilization. A balanced, slow-release fertilizer can be applied sparingly during the growing season, typically once or twice a year.
