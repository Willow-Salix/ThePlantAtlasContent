---
title: "Weber's Cetraria"
description: "Care guide for Cetraria weberi Essl."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/cetraria-weberi-essl
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Weber's Cetraria](https://upload.wikimedia.org/wikipedia/commons/4/46/Iceland_moss_-_Cetraria_islandica_%2830657503808%29.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Western North America (Rocky Mountains and Pacific Northwest high elevations) |
| **🌡️ Climate** | Alpine Tundra / Subalpine |
| **☀️ Light** | Full sun to high exposure, replicating its open alpine habitat. |
| **💧 Water** | High atmospheric humidity with occasional moisture from mist or rainfall, allowing for dry periods as it tolerates desiccation. |
...
## 🧤 Care Instructions
This alpine lichen thrives in full sun and requires high atmospheric humidity with occasional moisture, allowing for periods of dryness. It has very minimal nutrient needs, and traditional fertilizers are not only unnecessary but can be harmful to its growth.

### 🧪 Fertilizer
Extremely low; no fertilization is required and can be detrimental to its sensitive ecosystem.
