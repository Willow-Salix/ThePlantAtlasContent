...
description: "Care guide for Leonurus cardiaca L."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/leonurus-cardiaca-l
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Common Motherwort](https://upload.wikimedia.org/wikipedia/commons/6/68/Illustration_Leonurus_cardiaca0.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Central Asia and Southeastern Europe |
| **🌡️ Climate** | Temperate Grassland and Shrubland |
| **☀️ Light** | Full sun to partial shade, tolerating a range of light conditions common in open fields and forest edges. |
| **💧 Water** | Moderate; prefers consistent moisture but is drought-tolerant once established. Allow the top soil to dry slightly between waterings. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=5959038)

## 🧤 Care Instructions
Common Motherwort is a hardy temperate plant that flourishes in full sun to partial shade. It requires moderate, consistent watering but tolerates some drought, and its nutrient needs are minimal, thriving even in average soils. This makes it a low-maintenance and adaptable plant.

### 🧪 Fertilizer
Low; typically thrives in average to poor soils without heavy fertilization. An annual application of compost or a light, balanced fertilizer is sufficient if growth is poor.
