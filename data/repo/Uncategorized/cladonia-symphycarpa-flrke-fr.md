---
title: "Cup Lichen"
description: "Care guide for Cladonia symphycarpa (FlÃ¶rke) Fr."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/cladonia-symphycarpa-flrke-fr
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Cup Lichen
### *Cladonia symphycarpa (FlÃ¶rke) Fr.*
...
| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Temperate to boreal regions across North America, Europe, and Asia. |
| **🌡️ Climate** | Temperate/Boreal Forest and Heathland |
| **☀️ Light** | Moderate to bright indirect light. Can tolerate some morning sun but should be protected from harsh afternoon direct sunlight. |
| **💧 Water** | Requires high humidity and consistent moisture, absorbing water from air and rain. Allow for periods of drying between wetting, mimicking natural rain cycles. Avoid waterlogging. |
...
## 🧤 Care Instructions
This cup lichen thrives in cool, humid environments with moderate light, typical of temperate and boreal forests. It requires regular moisture from misting or rainfall, with brief dry periods, and does not need any fertilizer.

### 🧪 Fertilizer
No fertilizer required. Lichens obtain nutrients from the atmosphere and can be harmed by conventional fertilizers.
