---
title: Phyllostegia Mollis Benth. Var. Fagerlindii Sherff
description: Phyllostegia mollis Benth. var. fagerlindii Sherff
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
# Phyllostegia Mollis Benth. Var. Fagerlindii Sherff

*Phyllostegia mollis Benth. var. fagerlindii Sherff* • **Uncategorized**

![Phyllostegia Mollis Benth. Var. Fagerlindii Sherff](https://upload.wikimedia.org/wikipedia/commons/9/91/Phyllostegia_haliakalae.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Hawaiian Islands (specifically Maui, Molokaʻi, and Lānaʻi) |
| **Climate** | Wet Tropical Forest / Mesic Forest |
| **Sunlight** | Requires dappled to indirect light, mimicking the understory conditions of its native forest habitat; protect from direct, harsh sun which can scorch its leaves. |
| **Watering** | Needs consistently moist soil, but not waterlogged, reflecting the regular rainfall and high humidity of its native environment; allow the top inch of soil to dry slightly between waterings. |
...
## Care Guide
To care for this plant, provide consistent moisture in well-draining soil and ensure it receives dappled or indirect light, avoiding direct sun. Fertilize moderately during its active growth period to support its native forest growth habits.

### Fertilizer
Benefits from moderate fertilization, as native volcanic soils are often rich in organic matter; a balanced liquid fertilizer applied monthly during the growing season should suffice.
