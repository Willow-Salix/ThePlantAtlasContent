---
title: "Slenderleaf Buckwheat"
description: "Care guide for Eriogonum leptophyllum (Torr. & A. Gray) Wooton & Standl."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/eriogonum-leptophyllum-torr-a-gray-wooton-standl
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Slenderleaf Buckwheat](https://upload.wikimedia.org/wikipedia/commons/d/dc/Eriogonum_compositum_5077.JPG)
...
| **☀️ Light** | Requires full sun exposure (at least 6+ hours of direct sunlight daily) to mimic its open, exposed native habitat. |
| **💧 Water** | Drought-tolerant; water infrequently, allowing the soil to dry out completely between waterings. Overwatering can be detrimental. |
...
## 🧤 Care Instructions
Slenderleaf Buckwheat thrives in conditions simulating its native arid scrubland, requiring abundant full sun and very little water. It prefers well-draining soil and has low nutrient demands, making it an excellent choice for xeriscaping or drought-tolerant gardens.

### 🧪 Fertilizer
Low fertilizer needs due to its adaptation to nutrient-poor desert soils. Use a very diluted, balanced fertilizer sparingly in spring, or none at all if soil is adequate.
