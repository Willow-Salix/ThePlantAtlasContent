---
title: "Woolly Glycine"
description: "Care guide for Glycine comosa L."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/glycine-comosa-l
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Woolly Glycine](https://upload.wikimedia.org/wikipedia/commons/1/18/Glycine-2D-skeletal.svg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Australia (northern and eastern parts), Southeast Asia (e.g., Philippines, Taiwan), and Pacific Islands (e.g., Papua New Guinea, New Caledonia). |
| **🌡️ Climate** | Tropical and Subtropical Grasslands and Open Woodlands |
| **☀️ Light** | Full sun to partial sun, ideally receiving at least 6 hours of direct sunlight per day. |
| **💧 Water** | Moderate watering. Allow the soil to dry out slightly between waterings. It is somewhat drought-tolerant once established but thrives with consistent moisture during active growth. |
...
Glycine is a white, sweet-tasting crystalline solid, leading to its name from Greek word glykys (Greek: γλυκύς) or "sweet". While the body can synthesize it, it is also obtained from the diet and produced industrially by chemical synthesis for use as a food additive, a nutritional supplement, and an intermediate in the manufacture of products such as the herbicide glyphosate. In aqueous solutions, glycine exists predominantly as a zwitterion (H3N+CH2COO-), a polar molecule with both a positive and negative charge, making it highly soluble in water. It can also fit into hydrophobic environments due to its minimal side chain.



> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=11835)

## 🧤 Care Instructions
Woolly Glycine is a resilient vine native to tropical and subtropical regions, thriving in full to partial sun with well-drained soil. It requires moderate watering, allowing the soil to dry slightly between sessions. As a nitrogen-fixing legume, it needs minimal fertilization, making it a low-maintenance groundcover or climber.

### 🧪 Fertilizer
Minimal fertilization is needed. As a legume, it fixes nitrogen, so avoid high-nitrogen fertilizers. A balanced, diluted liquid fertilizer can be applied sparingly during the growing season if soil nutrients are very poor.
