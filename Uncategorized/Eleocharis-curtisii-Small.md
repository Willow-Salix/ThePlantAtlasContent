---
title: "Curtis's Spikerush"
description: "Care guide for Eleocharis curtisii Small"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/eleocharis-curtisii-small
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Curtis's Spikerush](https://upload.wikimedia.org/wikipedia/commons/6/61/Starr_081230-0543_Eleocharis_calva.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southeastern United States (e.g., Florida, Georgia, Alabama, Louisiana, Texas, Carolinas) |
| **🌡️ Climate** | Humid Subtropical (Wetland/Aquatic) |
| **☀️ Light** | Full sun to partial sun. Typically found in open, exposed wetland environments. |
| **💧 Water** | Constantly wet to submerged conditions; thrives in shallow water or perpetually moist soil. Cannot tolerate drying out. |
...
## 🧤 Care Instructions
Eleocharis curtisii requires a consistently wet to submerged environment, mirroring its native wetland habitat. Provide ample sunlight and ensure the soil never dries out to promote healthy growth.

### 🧪 Fertilizer
Low to moderate. Wetland plants often adapt to less nutrient-rich environments. A balanced liquid fertilizer can be applied sparingly if needed.
