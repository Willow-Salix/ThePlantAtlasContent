---
title: Smooth Sideranthus
description: Sideranthus laevis Wooton & Standl.
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Sideranthus laevis Wooton & Standl.* • **Uncategorized**

![Smooth Sideranthus](https://upload.wikimedia.org/wikipedia/commons/c/c3/Xanthisma_spinulosum_3.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Southwestern United States (e.g., New Mexico, Arizona, Texas) and Northern Mexico (e.g., Sonora) |
| **Climate** | Arid Scrubland / Desert |
| **Sunlight** | Full sun to partial shade. Prefers full sun exposure to mimic its native desert environment. |
| **Watering** | Infrequent deep watering; highly drought-tolerant. Allow soil to dry out completely between waterings to simulate natural rainfall patterns. |
...
## Care Guide
This desert native thrives on neglect, requiring full sun exposure and very infrequent watering, as it is highly drought-tolerant. Mimicking its arid habitat, ensure well-draining soil and avoid over-fertilization, as its nutrient needs are minimal.

### Fertilizer
Low to no fertilizer. Native desert soils are often nutrient-poor, so this plant does not require rich soil or frequent feeding.
