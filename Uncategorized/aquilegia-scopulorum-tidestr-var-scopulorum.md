---
title: "Utah Columbine"
description: "Care guide for Aquilegia scopulorum Tidestr. var. scopulorum"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/aquilegia-scopulorum-tidestr-var-scopulorum
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Utah Columbine
### *Aquilegia scopulorum Tidestr. var. scopulorum*

![Utah Columbine](https://upload.wikimedia.org/wikipedia/commons/b/bb/Wald-Akelei.JPG)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Western United States (specifically the Rocky Mountain region including Utah, Nevada, Arizona, Idaho, Wyoming, Colorado) |
| **🌡️ Climate** | Alpine/Subalpine |
| **☀️ Light** | Full sun to partial shade; prefers some afternoon shade in hotter climates to prevent scorching. |
| **💧 Water** | Regular watering to maintain consistently moist but well-drained soil; thrives in conditions mimicking mountain streams or seeps. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=6828)

## 🧤 Care Instructions
Utah Columbine flourishes in conditions similar to its high-altitude native habitat, requiring full sun to partial shade (with afternoon shade in intense heat) and consistently moist, well-drained soil. Avoid over-fertilizing, as it prefers lean conditions and relies more on consistent moisture.

### 🧪 Fertilizer
Minimal to no fertilizer; if needed, a light application of a balanced, slow-release formula in early spring is sufficient.
