---
title: Wild Mustard
description: Brassica kaber (DC.) L.C. Wheeler var. orientalis (L.) Scoggan
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Brassica kaber (DC.) L.C. Wheeler var. orientalis (L.) Scoggan* • **Uncategorized**

![Wild Mustard](https://upload.wikimedia.org/wikipedia/commons/b/b8/Barbarea_vulgaris_002.JPG)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Europe, North Africa, Western and Central Asia |
| **Climate** | Temperate Grassland/Agricultural Lands |
| **Sunlight** | Full Sun (requires direct, unfiltered sunlight for most of the day due to its native open field environment). |
| **Watering** | Moderate watering, allowing the topsoil to dry slightly between waterings. It is tolerant of short dry spells once established, reflecting the variable rainfall of temperate regions. |
...
> [Read full article on Wikipedia](https://en.wikipedia.org/?curid=3794)

## Care Guide
Wild Mustard is a hardy plant that flourishes in full sun and open environments. It requires moderate watering, tolerating some drought once established, and has low fertilizer needs, adapting well to average soil conditions.

### Fertilizer
Low; thrives in average to poor soil conditions typical of disturbed agricultural lands and requires minimal supplemental feeding.
