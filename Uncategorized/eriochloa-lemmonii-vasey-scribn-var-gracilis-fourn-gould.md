---
title: "Gracilis Cupgrass"
description: "Care guide for Eriochloa lemmonii Vasey & Scribn. var. gracilis (Fourn.) Gould"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/eriochloa-lemmonii-vasey-scribn-var-gracilis-fourn-gould
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Gracilis Cupgrass
### *Eriochloa lemmonii Vasey & Scribn. var. gracilis (Fourn.) Gould*

![Gracilis Cupgrass](https://upload.wikimedia.org/wikipedia/commons/e/eb/Eriochloapolystachya.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (Arizona, New Mexico, Texas) and Mexico |
| **🌡️ Climate** | Semi-Arid Grassland |
| **☀️ Light** | Full Sun (at least 6 hours of direct sunlight daily) |
| **💧 Water** | Moderate to Low, allowing soil to dry out completely between waterings; drought-tolerant. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=15376083)

## 🧤 Care Instructions
This drought-tolerant grass thrives in full sun typical of its native semi-arid grasslands. It prefers well-draining soil and requires moderate to low watering, allowing the soil to dry out completely between applications. Fertilization needs are minimal, making it a low-maintenance plant.

### 🧪 Fertilizer
Low to Moderate; a balanced, slow-release fertilizer once in spring if growth seems weak, otherwise minimal.
