...
*Aplectrum Torr.* • **Uncategorized**

![Adam and Eve](https://upload.wikimedia.org/wikipedia/commons/6/63/Peter_Paul_Rubens_-_Adam_and_Eve%2C_after_Titian%2C_between_1628_and_1629.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Eastern North America (spanning from Canada to the Southern United States) |
| **Climate** | Temperate Deciduous Forest |
| **Sunlight** | Partial to full shade. Prefers dappled light or morning sun, typical of a forest understory, and should be protected from harsh afternoon sun. |
| **Watering** | Keep soil consistently moist but never waterlogged during the active growing season (spring through fall). Allow the topsoil to dry slightly between waterings during its winter dormancy. |
...
> [Read full article on Wikipedia](https://en.wikipedia.org/?curid=11473533)

## Care Guide
To care for this temperate forest orchid, replicate its native understory environment by providing partial to full shade with dappled light. Maintain consistently moist, well-draining soil during active growth, reducing water during its dormant period in winter.

### Fertilizer
Fertilize sparingly with a highly diluted (e.g., 1/4 strength) balanced liquid fertilizer every 2-4 weeks during the growing season. Reduce or stop fertilization during dormancy.
