---
title: Physcia Lithotodes
description: Physcia lithotodes Nyl.
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Physcia lithotodes Nyl.* • **Uncategorized**

![Physcia Lithotodes](https://upload.wikimedia.org/wikipedia/commons/0/02/Physcia_atrostriata_-_Flickr_-_pellaea_%281%29.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Widespread across temperate regions globally, particularly Europe and North America, often on calcareous rocks. |
| **Climate** | Temperate, typically found in rocky outcrops, forest edges, and exposed areas with moderate humidity. |
| **Sunlight** | Moderate to bright indirect light, tolerating some direct sun, especially during cooler parts of the day. |
| **Watering** | Requires periods of high humidity or direct moisture (rain, dew) followed by drying. Regular misting can simulate natural conditions, but avoid prolonged saturation. |
...
## Care Guide
This lichen thrives in temperate climates on suitable rock substrates, preferring moderate to bright indirect light. It requires regular exposure to moisture, such as rain or mist, followed by periods of drying. Traditional fertilizers should be avoided as they are harmful to its delicate ecosystem.

### Fertilizer
Not applicable. Lichens absorb nutrients directly from the air and precipitation and are highly sensitive to traditional chemical fertilizers, which can be detrimental.
