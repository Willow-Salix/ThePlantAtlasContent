---
title: "Confederate Violet"
description: "Care guide for Viola papilionacea Pursh var. priceana (Pollard) Alexander"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/viola-papilionacea-pursh-var-priceana-pollard-alexander
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Confederate Violet](https://upload.wikimedia.org/wikipedia/commons/c/cd/Bratsche.jpg)
...
| **🌡️ Climate** | Temperate Deciduous Forest / Humid Subtropical |
| **☀️ Light** | Partial to Full Shade (especially afternoon shade) |
| **💧 Water** | Keep soil consistently moist but not waterlogged; water regularly, particularly during dry periods. |
...
## 🧤 Care Instructions
The Confederate Violet thrives in partial to full shade with consistently moist, well-drained, and organically rich soil. Mimicking its native humid subtropical forest environment, it requires regular watering and benefits from minimal fertilization. This makes it an excellent, low-maintenance groundcover for shady garden areas.

### 🧪 Fertilizer
Minimal; a light application of balanced, all-purpose fertilizer in early spring if soil is poor, otherwise incorporate organic matter annually.
