---
title: Indian Lovegrass
description: Eragrostis pilosa (L.) P. Beauv. var. pilosa
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Eragrostis pilosa (L.) P. Beauv. var. pilosa* • **Uncategorized**

![Indian Lovegrass](https://upload.wikimedia.org/wikipedia/commons/2/20/Starr_020124-8001_Eragrostis_cilianensis.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Eurasia and Africa |
| **Climate** | Temperate to Subtropical Grassland and Open Fields |
| **Sunlight** | Full sun (6+ hours direct sunlight daily) due to its native habitat in open, exposed areas. |
| **Watering** | Moderate to low; established plants are drought-tolerant and can withstand dry periods, benefiting from occasional watering during prolonged droughts or active growth. |
...
## Care Guide
This resilient grass thrives in full sun, reflecting its native open grassland habitat. Once established, it is highly drought-tolerant, requiring infrequent watering. Minimal fertilization is needed, as it is adapted to less fertile soil conditions.

### Fertilizer
Low; adapted to relatively poor or disturbed soils, it typically does not require frequent fertilization.
