---
title: "Phyllostegia parviflora (Gaudich.) Benth. var. canescens Sherff"
description: "Care guide for Phyllostegia parviflora (Gaudich.) Benth. var. canescens Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/phyllostegia-parviflora-gaudich-benth-var-canescens-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Phyllostegia parviflora (Gaudich.) Benth. var. canescens Sherff
### *Phyllostegia parviflora (Gaudich.) Benth. var. canescens Sherff*

![Phyllostegia parviflora (Gaudich.) Benth. var. canescens Sherff](https://upload.wikimedia.org/wikipedia/commons/9/91/Phyllostegia_haliakalae.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Hawaii, USA (endemic to the islands of Maui and Hawaiʻi) |
| **🌡️ Climate** | Tropical Montane Wet Forest and Shrubland |
| **☀️ Light** | Partial shade to filtered sunlight is ideal, mimicking its natural habitat beneath a forest canopy or at forest edges. Avoid intense, direct afternoon sun. |
| **💧 Water** | Consistent and high moisture is crucial. The soil should be kept continuously moist but well-draining, never allowing it to dry out completely. High ambient humidity is also essential. |
...
## 🧤 Care Instructions
This rare Hawaiian native requires conditions similar to its wet montane forest origin: consistent soil moisture, very high humidity, and filtered or dappled sunlight. Protect it from drying out and harsh sun to ensure optimal health.

### 🧪 Fertilizer
Moderate fertilization with a balanced liquid fertilizer (e.g., at half strength) during its active growing season is sufficient. Benefits from soil rich in organic matter.
