---
title: "Skottsberg's Spurge"
description: "Care guide for Euphorbia skottsbergii Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-skottsbergii-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Skottsberg's Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Hawaiian Islands (Oahu, Maui, Molokai, Lanai, Kauai, Hawaii) |
| **🌡️ Climate** | Tropical Dry Forest and Subtropical Dry Shrubland |
| **☀️ Light** | Full sun to partial shade, thriving with several hours of direct sunlight daily. |
| **💧 Water** | Allow soil to dry out completely between waterings. Water moderately during active growth, mimicking its native wet-dry seasonal cycles; reduce watering during dormant periods. |
...
## 🧤 Care Instructions
This Hawaiian native thrives in bright light and well-draining soil, accustomed to distinct wet and dry seasons. Water deeply when the soil is dry, then allow it to dry out fully before the next watering, and provide minimal fertilization during its active growth.

### 🧪 Fertilizer
Low to moderate fertilization. Apply a balanced, slow-release fertilizer once or twice during the active growing season.
