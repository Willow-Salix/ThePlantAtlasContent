---
title: "Prairie Spurge"
description: "Care guide for Euphorbia missurica Raf. var. intermedia (Engelm.) L.C. Wheeler"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-missurica-raf-var-intermedia-engelm-lc-wheeler
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Prairie Spurge
### *Euphorbia missurica Raf. var. intermedia (Engelm.) L.C. Wheeler*

![Prairie Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Central North America (primarily Great Plains and Midwestern United States) |
| **🌡️ Climate** | Temperate Grassland (Prairie/Open Woodland) |
| **☀️ Light** | Full sun (at least 6 hours of direct sunlight daily) is essential for optimal growth, reflecting its open prairie habitat. |
| **💧 Water** | Drought-tolerant once established, preferring well-drained soil. Water moderately when the topsoil is dry, allowing it to dry out completely between waterings. Avoid overwatering and waterlogging. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=61880)

## 🧤 Care Instructions
Prairie Spurge is a low-maintenance plant that thrives in full sun and well-drained soil, mimicking its native grassland habitat. It is highly drought-tolerant once established, requiring infrequent watering, and has minimal fertilizer needs.

### 🧪 Fertilizer
Low. This plant thrives in lean soils and typically does not require much fertilization. A light, balanced fertilizer can be applied sparingly in spring if the soil is exceptionally poor.
