---
title: "Kalaeloa Spurge"
description: "Care guide for Euphorbia skottsbergii Sherff var. kalaeloana Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-skottsbergii-sherff-var-kalaeloana-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Kalaeloa Spurge
### *Euphorbia skottsbergii Sherff var. kalaeloana Sherff*

![Kalaeloa Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Kalaeloa Plain, Oʻahu, Hawaiʻi, USA |
| **🌡️ Climate** | Tropical Dry Shrubland / Coastal Dry Forest |
| **☀️ Light** | Full sun, requiring intense, direct sunlight for most of the day, reflecting its open coastal habitat. |
| **💧 Water** | Infrequent watering; allow soil to dry out completely between waterings, as it is highly drought-tolerant and adapted to dry periods. |
...
## 🧤 Care Instructions
This rare Hawaiian spurge thrives in full sun and requires minimal watering, adapting to its native dry coastal environment. Use a well-draining, sandy soil mix and provide very infrequent, diluted fertilization to mimic its natural, nutrient-poor habitat.

### 🧪 Fertilizer
Low to none; native soils are typically poor and sandy, so use very diluted fertilizer sparingly, if at all, during the growing season.
