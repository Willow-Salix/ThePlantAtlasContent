---
title: Cleftleaf Wildheliotrope
description: Phacelia crenulata Torr. ex S. Watson var. minutiflora (J. Voss) Jeps.
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Phacelia crenulata Torr. ex S. Watson var. minutiflora (J. Voss) Jeps.* • **Uncategorized**

![Cleftleaf Wildheliotrope](https://upload.wikimedia.org/wikipedia/commons/f/fb/Phacelia_tanacetifolia_7735.JPG)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Southwestern United States (California, Nevada, Arizona, Utah) and Northwestern Mexico |
| **Climate** | Arid Scrubland / Desert |
| **Sunlight** | Full sun (at least 6-8 hours of direct sunlight daily) is essential for optimal growth. |
| **Watering** | Extremely drought-tolerant. Water infrequently and deeply, allowing the soil to dry out completely between waterings; avoid overwatering at all costs. |
...
## Care Guide
This desert annual requires full sun and is highly drought-tolerant, needing infrequent deep watering. It prefers poor, well-draining soil and minimal to no fertilization. The key is to mimic its arid native environment to prevent issues like root rot.

### Fertilizer
Low to no fertilizer needed. This plant thrives in lean, nutrient-poor soils characteristic of its desert habitat. Excessive fertilization can be detrimental.
