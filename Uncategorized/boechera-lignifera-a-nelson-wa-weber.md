---
title: "Woody-stemmed Rockcress"
description: "Care guide for Boechera lignifera (A. Nelson) W.A. Weber"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/boechera-lignifera-a-nelson-wa-weber
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
# Woody-stemmed Rockcress
### *Boechera lignifera (A. Nelson) W.A. Weber*

![Woody-stemmed Rockcress](https://upload.wikimedia.org/wikipedia/commons/7/74/Boechera_drummondii.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (Wyoming, Colorado, Utah, New Mexico, Arizona) |
| **🌡️ Climate** | Alpine and Subalpine Tundra/Rocky Slopes |
| **☀️ Light** | Full sun, thriving in high light intensity typical of mountainous regions. |
| **💧 Water** | Moderate watering, allowing the soil to dry out completely between applications. Tolerant of drought once established. |
...
## 🧤 Care Instructions
This Rocky Mountain native thrives in full sun and well-drained, lean soils, typical of its alpine and subalpine habitat. Provide moderate watering, allowing the soil to dry out between applications, and avoid over-fertilizing to mimic its natural, nutrient-poor environment.

### 🧪 Fertilizer
Minimal to none; thrives in lean, nutrient-poor, rocky soils. Over-fertilization can be detrimental.
