---
title: Anderson's Buttercup
description: Ranunculus andersonii A. Gray
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Ranunculus andersonii A. Gray* • **Uncategorized**

![Anderson's Buttercup](https://upload.wikimedia.org/wikipedia/commons/d/d9/Ranunculus_eschscholtzii.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Western United States (Intermountain West, including Nevada, Utah, Idaho, Oregon, and California) |
| **Climate** | Temperate Steppe / Subalpine Scrubland |
| **Sunlight** | Full sun to partial sun exposure. Thrives in open, unshaded areas or light shade found in sparse woodlands and sagebrush scrub. |
| **Watering** | Moderate watering during active growth in spring, allowing the soil to dry out between waterings. Requires dry conditions during summer dormancy, mimicking natural snowmelt and spring rains followed by summer drought. |
...
## Care Guide
Anderson's Buttercup, a native of the western US, prefers full to partial sun and thrives with moderate spring watering. It needs well-drained soil and drier conditions during its summer dormancy, typically requiring low to moderate fertilization. Mimic its natural environment of seasonal moisture followed by drought.

### Fertilizer
Low to moderate fertilization. Benefits from a balanced, slow-release fertilizer once in early spring if soil is poor, but generally does not require heavy feeding.
