---
title: "Avocado"
description: "Care guide for Persea americana Mill."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/persea-americana-mill
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Avocado](https://upload.wikimedia.org/wikipedia/commons/f/f2/Persea_americana_fruit_2.JPG)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southern Mexico and Central America (primarily Guatemala and Puebla, Mexico) |
| **🌡️ Climate** | Tropical and Subtropical Forest (often in highland regions) |
| **☀️ Light** | Full sun (at least 6-8 hours daily) for mature, fruit-producing trees. Young trees can tolerate partial shade initially, mimicking understory conditions. |
| **💧 Water** | Consistent and ample watering is crucial, especially during dry periods and fruit development. Requires excellent drainage to prevent root rot, as native forest soils are often well-aerated despite high rainfall. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=166017)

## 🧤 Care Instructions
Avocado trees flourish in conditions similar to their tropical highland origins, demanding full sun, consistent moisture paired with excellent drainage, and regular nutrient feeding. Protect from frost and ensure well-aerated soil to support robust growth and abundant fruit production.

### 🧪 Fertilizer
Regular fertilization with a balanced, slow-release fertilizer rich in nitrogen, phosphorus, and potassium, as well as micronutrients (like zinc), is beneficial, particularly during growth flushes and fruiting. Native forest soils are naturally rich but depleted by fruiting.
