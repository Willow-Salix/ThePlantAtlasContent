...
description: Phoradendron serotinum (Raf.) M.C. Johnst. var. macrotomum (Trel.) M.C. Johnst.
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Phoradendron serotinum (Raf.) M.C. Johnst. var. macrotomum (Trel.) M.C. Johnst.* • **Uncategorized**

![American Mistletoe](https://upload.wikimedia.org/wikipedia/commons/2/2f/Phoradendroncalifornicum2.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Southwestern United States (Arizona, New Mexico, Texas) and Mexico |
| **Climate** | Semi-Arid Woodlands and Desert Scrub |
| **Sunlight** | Bright, indirect light to partial sun, as it grows within the canopy of host trees. |
| **Watering** | Dependent on the host tree's moisture, typically infrequent but deep watering events, mimicking rainfall patterns in semi-arid regions. |
...
> [Read full article on Wikipedia](https://en.wikipedia.org/?curid=5692214)

## Care Guide
As a parasitic plant, its care is entirely dependent on the health of its host tree. It requires bright, indirect light and the consistent moisture and nutrients provided by a thriving host, adapted to semi-arid conditions.

### Fertilizer
No external fertilizer required, as it obtains all nutrients directly from its host tree.
