---
title: "David's Spurge"
description: "Care guide for Euphorbia davidii Subils"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/euphorbia-davidii-subils
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![David's Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Central and Eastern North America (United States and Canada) |
| **🌡️ Climate** | Temperate Grassland and Forest Edge |
| **☀️ Light** | Prefers full sun to partial shade. Thrives in open, well-lit areas. |
| **💧 Water** | Moderate watering. Tolerates periods of drought once established, but performs best with consistent moisture, allowing soil to dry slightly between waterings. |
...
## 🧤 Care Instructions
David's spurge is an adaptable plant native to temperate regions of North America, favoring sunny to partly shaded locations. It requires moderate watering but is somewhat drought-tolerant once established, and has low fertilizer needs. Mimic its native disturbed, open habitat for best growth.

### 🧪 Fertilizer
Low to moderate. Typically does not require extensive fertilization, as it often grows in nutrient-poor or disturbed soils.
