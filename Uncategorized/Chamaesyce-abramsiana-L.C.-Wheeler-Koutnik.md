---
title: Abrams' Sandmat
description: Chamaesyce abramsiana (L.C. Wheeler) Koutnik
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Chamaesyce abramsiana (L.C. Wheeler) Koutnik* • **Uncategorized**

![Abrams' Sandmat](https://upload.wikimedia.org/wikipedia/commons/c/cf/Starr_080531-4851_Chamaesyce_hypericifolia.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Southwestern United States (California, Nevada, Arizona) |
| **Climate** | Arid Scrubland/Desert |
| **Sunlight** | Full Sun (requires direct sun for most of the day) |
| **Watering** | Low (allow soil to dry out completely between waterings, drought-tolerant) |
...
## Care Guide
Abrams' Sandmat thrives in bright, full sun and dry conditions, typical of its native desert and scrubland habitats. It is highly drought-tolerant, requiring minimal watering, and does not need frequent fertilization due to its adaptation to nutrient-poor soils. This makes it a very low-maintenance plant ideal for xeric gardening.

### Fertilizer
Low to None (adapted to nutrient-poor soils; minimal or no fertilization needed)
