---
title: "Ulihi Phyllostegia"
description: "Care guide for Phyllostegia glabra (Gaudich.) Benth. var. lanaiensis Sherff"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/phyllostegia-glabra-gaudich-benth-var-lanaiensis-sherff
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Ulihi Phyllostegia](https://upload.wikimedia.org/wikipedia/commons/9/91/Phyllostegia_haliakalae.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Lana'i, Hawaii, USA |
| **🌡️ Climate** | Tropical Moist Forest |
| **☀️ Light** | Partial shade to bright, indirect light. Protect from direct, intense midday sun. |
| **💧 Water** | Keep soil consistently moist but not waterlogged; water thoroughly when the top inch of soil begins to feel dry. Requires high ambient humidity. |
...
## 🧤 Care Instructions
As an endemic to the moist forests of Lana'i, Ulihi Phyllostegia requires consistently moist, well-draining soil and high humidity. It thrives in bright, indirect light or partial shade, needing protection from harsh direct sun, and benefits from regular, diluted feeding during its growing period.

### 🧪 Fertilizer
Moderate. Apply a balanced, diluted liquid fertilizer monthly or bi-monthly during the active growing season (spring through summer).
