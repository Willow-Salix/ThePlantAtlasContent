---
title: "Lacy Phacelia"
description: "Care guide for Phacelia tanacetifolia Benth."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/phacelia-tanacetifolia-benth
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Lacy Phacelia](https://upload.wikimedia.org/wikipedia/commons/f/fb/Phacelia_tanacetifolia_7735.JPG)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Southwestern United States (primarily California) and northwestern Mexico (Baja California). |
| **🌡️ Climate** | Mediterranean and Arid/Semi-arid Scrubland. |
| **☀️ Light** | Requires full sun exposure, reflecting its native habitats in open grasslands, disturbed areas, and chaparral where it receives direct sunlight. |
| **💧 Water** | Needs moderate watering during germination and active growth. Once established, it is highly drought-tolerant and prefers infrequent, deep watering, allowing the soil to dry out completely between sessions, consistent with its adaptation to seasonal rainfall. |
...
## 🧤 Care Instructions
Lacy Phacelia thrives in full sun and well-draining soil, mimicking its native Mediterranean and arid environments. Provide moderate water during its growing season, then reduce frequency as it tolerates drought. Avoid excessive fertilization as it prefers lean conditions.

### 🧪 Fertilizer
Adapts well to poor to moderately fertile soils and typically does not require heavy fertilization. Excessive nutrients can lead to lush foliage but fewer flowers; a very light, balanced feed might be used only in extremely poor soils.
