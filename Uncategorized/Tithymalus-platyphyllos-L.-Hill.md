---
title: Broad-leaved Spurge
description: Tithymalus platyphyllos (L.) Hill
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Tithymalus platyphyllos (L.) Hill* • **Uncategorized**

![Broad-leaved Spurge](https://upload.wikimedia.org/wikipedia/commons/6/62/Euphorbia_February_2008-2.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Europe, North Africa, and Central Asia |
| **Climate** | Temperate |
| **Sunlight** | Full Sun to Partial Shade, preferring ample light exposure. |
| **Watering** | Moderate watering, allowing the soil to dry out slightly between waterings; it is relatively drought-tolerant once established in its native temperate climate. |
...
## Care Guide
Broad-leaved Spurge is a hardy plant adapted to temperate climates, thriving with full sun to partial shade exposure. It prefers moderate watering, tolerating some drought once established, and requires low fertilization. This robust plant can flourish in various soil types without intensive care.

### Fertilizer
Low fertilization, as it can thrive in average to poor soil conditions and does not require rich nutrient input.
