---
title: "Cypress-leaved Plaitmoss"
description: "Care guide for Hypnum cupressiforme Hedw. var. imponens (Hedw.) Guim."
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/hypnum-cupressiforme-hedw-var-imponens-hedw-guim
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
### *Hypnum cupressiforme Hedw. var. imponens (Hedw.) Guim.*

![Cypress-leaved Plaitmoss](https://upload.wikimedia.org/wikipedia/commons/8/8b/Hypnum_cupressiforme0.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Cosmopolitan in temperate and humid subtropical regions, including Europe, North America, Asia, and Australasia. |
| **🌡️ Climate** | Temperate Forests and Humid Subtropical Woodlands (often found on logs, rocks, or soil, under tree canopy). |
| **☀️ Light** | Low to Partial Light. Prefers indirect light or shade; direct, intense sunlight should be avoided. |
| **💧 Water** | High. Requires consistently moist conditions, but not waterlogged. High ambient humidity is crucial for its health and growth. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=18541760)

## 🧤 Care Instructions
This moss thrives in consistently moist, shaded environments, mimicking its native habitat on forest floors or rocks. Ensure high humidity and never allow it to dry out completely, but avoid standing water. Fertilization is generally unnecessary due to its low nutrient requirements.

### 🧪 Fertilizer
Very Low. Mosses generally do not require fertilization; excessive nutrients can be detrimental and are rarely beneficial.
