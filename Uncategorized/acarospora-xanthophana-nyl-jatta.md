---
title: "Acarospora xanthophana"
description: "Care guide for Acarospora xanthophana (Nyl.) Jatta"
published: true
date: 2025-12-02
editor: markdown
path: uncategorized/acarospora-xanthophana-nyl-jatta
tags:
  - Uncategorized
  - Flora
  - Auto-Generated
...
![Acarospora xanthophana](https://upload.wikimedia.org/wikipedia/commons/b/b8/Acarospora_glaucocarpa_45871.jpg)

## 📋 Quick Specs

| Feature | Detail |
| :--- | :--- |
| **🌍 Origin** | Widespread in arid to semi-arid regions globally, including southwestern North America (e.g., California, Arizona) and parts of Europe. |
| **🌡️ Climate** | Arid Scrubland to Semi-Arid Temperate, typically found on exposed siliceous rock surfaces. |
| **☀️ Light** | Full sun to high light exposure, as it naturally occurs on open rock outcrops with minimal shading. |
| **💧 Water** | Extremely low. This lichen absorbs moisture from atmospheric humidity, dew, and infrequent rainfall. Direct or excessive watering is detrimental; dry conditions are preferred. |
...
> [Read full Wikipedia entry](https://en.wikipedia.org/?curid=22503174)

## 🧤 Care Instructions
Acarospora xanthophana is a crustose lichen that thrives in dry, sunny, and exposed rocky habitats. It requires extremely low moisture, relying on ambient humidity and infrequent natural precipitation, and needs no fertilization.

### 🧪 Fertilizer
None. Lichens acquire all necessary nutrients from atmospheric dust, rainwater, and the mineral substrate. Traditional fertilization is unnecessary and can be harmful.
