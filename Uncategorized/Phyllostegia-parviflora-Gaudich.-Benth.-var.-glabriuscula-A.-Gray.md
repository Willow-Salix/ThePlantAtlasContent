---
title: Smallflower Phyllostegia
description: Phyllostegia parviflora (Gaudich.) Benth. var. glabriuscula A. Gray
published: true
date: 2025-12-02
tags: 
  - Uncategorized
...
*Phyllostegia parviflora (Gaudich.) Benth. var. glabriuscula A. Gray* • **Uncategorized**

![Smallflower Phyllostegia](https://upload.wikimedia.org/wikipedia/commons/9/91/Phyllostegia_haliakalae.jpg)

## Quick Facts

| Property | Value |
| :--- | :--- |
| **Native Origin** | Hawaiian Islands (USA) |
| **Climate** | Tropical Wet Forest / Montane Wet Forest |
| **Sunlight** | Bright indirect light to partial shade; avoid harsh direct midday sun which can scorch leaves, mimicking its native understory or forest edge habitat. |
| **Watering** | Keep soil consistently moist but never waterlogged, reflecting the frequent rainfall and high humidity of its native environment. Ensure good drainage. |
...
Phyllostegia mollis Benth. - Hawaiian Islands  (Maui, Oʻahu)
...
## Care Guide
This Hawaiian native requires conditions mirroring its tropical wet forest home. Provide bright indirect light or partial shade, consistently moist but well-draining soil, and high humidity. Fertilize moderately during active growth for optimal health.

### Fertilizer
Moderate fertilization during the growing season (spring/summer) with a balanced, slow-release or diluted liquid fertilizer, consistent with the nutrient cycling in rich forest soils.
